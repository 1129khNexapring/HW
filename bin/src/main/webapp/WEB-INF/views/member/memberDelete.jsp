...
<body>
	...
	<div class=all>
		...
		<div class="form_table">
			<form action="/member/remove.kh" method="post">
				<table>
					<tr>
						<td class="td_left">아이디</td>
						<td class="td_right">
							<input type="text" name="memberId" value="${loginUser.memberId }" class="input">
						</td>
					</tr>
					<tr>
						<td class="td_left">비밀번호</td>
						<td class="td_right">
							<input type="password" name="memberPw" placeholder="비밀번호를 입력해주세요" value="" class="input">
						</td>
					</tr>
					<tr>
