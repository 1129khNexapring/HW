					...
					<form>
						...
						<table>
							<tr class="top">
								...
								<td class="td_right">
								<span id="resNo">${history.resNo }</span>
								</td>
								<td class="td_left">진료일</td>
								<td class="td_right"><span id="deptDate">${history.deptDate }</span></td>
							</tr>
							<tr>
								<td class="td_left">의료진</td>
								<td class="td_right"><span id="deptStaff">${history.deptStaff }</span></td>
								<td class="td_left">진료과</td>
								<td class="td_right"><span id="department">${history.department }</span></td>
							</tr>
							<tr>
								<td class="td_left">환자명</td>
								<td class="td_right"><span id="resName">${history.resName }</span></td>
								<td class="td_left">청구 금액(원)</td>
								<td class="td_right"><span id="charge">${history.charge }</span></td>
							</tr>
							<tr>
							...
							<tr class="bottom">
								<td colspan="2"><textarea name="deptContents" readonly>${history.deptContents }</textarea></td>
								<td colspan="2"><textarea name="prescription" readonly>${history.prescription }</textarea></td>
							</tr>
							<tr>
								<td colspan="4" align="center">
									<button class="submit" type="button" onclick="location.href='/history/remove.kh?resNo=${history.resNo }'">삭제</button>
								</td>
							</tr>
						</table>
				    </form>
