...
<head>
    ...
    <title>동행서비스 예약 비회원 정보 입력</title>
			...
			<div class="inner2">
				...
				<div id="content_box">
					<div class="notice_page_title">
						<h2 class="tit_page">동행서비스 예약 정보 조회</h2>		
					</div>
		      </div>
              <div class="section1">
                  <div class="section2">
                  <form action="reservation/view.kh" method="post">
                    <table align="center">        
                        <tr id="tr1">
                           <td class="td_left">이름</td>
                           <td class="td_right">
                              <input type="text" name="resName" value="${tresName }" id="input" placeholder="이름을 입력해주세요.">
                           </td>
                        </tr>
                        <tr id="tr1">
