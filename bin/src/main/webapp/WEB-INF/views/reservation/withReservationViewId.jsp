			...
			<div class="inner2">
				<div id="snb">
    				...
    				<ul class="snb_nav">
    					...
    					<c:if test="${not empty sessionScope }">
    						<li><a href="/withReservationView.kh" class="link_sb1" id="point">동행서비스 예약 확인</a></li>
    					</c:if>
    					</ul>
			  </div>
				<div id="content_box">
      ...
      <form>
         <table>
            ...
            <tr id="tr1">
               ...
               <td>
                  <span id="address">${reservation.address }</span>
               </td>
            </tr>
            <tr id="tr1">
            ...
            <tr id="tr1">
               ...
               <td>
                  <span id="acc">${reservation.acc }</span>
               </td>
            </tr>
            <tr id="tr1">
            ...
            <tr>
               <td colspan="2" align="center">
                  <button  class="submit" type="button" onclick="location.href='/reservation/remove.kh?resName=${reservation.resName}&phone=${reservation.phone }&birth=${reservation.birth }'">예약 취소</button>
               </td>
            </tr>
         </table>
      </form>
