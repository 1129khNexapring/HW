...
<body>
		...
		<div id="content" class="sub">
			<div class="">
				<div id="">
    				...
    				<ul class="">
    					<li><a href="/historyList.kh" class="">진료 이력</a></li>     					
    				</ul>
                    <ul class="">
    ...
    <h1>진료 이력</h1>
    <hr class="one">
	<form action="/history/modify.kh" method="post">
		<table>
			<h4>진료 이력 입력</h4>
			<hr class="two">
			<tr>
				<td>예약번호
					<select name="resNo">
						<option>${history.resNo }</option>
					</select>
				</td>
				<td>진료일<input type="text" name="deptDate" value="${history.deptDate }"></td>
			</tr>
			<tr>
				<td>의료진<input type="text" name="doctorId" value="${history.doctorId }"></td>
				<td>진료과<input type="text" name="department" value="${history.department }"></td>
			</tr>
			<tr>
				<td>환자명<input type="text" name="resName" value="${history.resName }"></td>
				<td>청구 금액(원)<input type="text" name="charge" value="${history.charge }"></td>
			</tr>
			<tr>
				<td>
					진료 내용<textarea rows ="" cols="" name="deptContents">${history.deptContents }</textarea>
				</td>
				<td>
					약 처방 내용<textarea rows ="" cols="" name="prescription">${history.prescription }</textarea>
				</td>
			</tr>
		</table>
    	<tr>
