...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<body>
		...
		<div class="member">의사 회원가입</div>
		<p>회원정보 입력</p>
		<div class="form_table">
			<form action="/doctor/register.kh" method="post">
				<table>
					<tr>
						<td class="td_left"><font color="#f00"> * </font>사원번호</td>
						<td class="td_right"><input type="text" name="doctorNo" placeholder="사원번호를 입력하세요." class="input"></td>
					</tr>
				
					<tr>
						<td class="td_left"><font color="#f00"> * </font>이름</td>
						<td class="td_right"><input type="text" name="doctorName" placeholder="이름을 입력하세요." class="input"></td>
					</tr>
					<tr>
						<td class="td_left"><font color="#f00"> * </font>아이디</td>
						<td class="td_right">
							<input type="text" id="doctorId" name="doctorId" placeholder="아이디를 입력하세요." class="input">
					...
					<tr>
						...
						<td class="td_right">
							<input type="password" name="doctorPw" placeholder="비밀번호를 입력하세요." class="input" id="pw">
						</td>
					</tr>
					<tr>
						<td class="td_left"><font color="#f00"> * </font>비밀번호 확인</td>
						<td>
							<input type="password" name="doctorPw2" placeholder="비밀번호를 한 번 더 입력하세요." class="input" onchange="check_pw()" id="pw2">
							<span id="check"></span>
						</td>
					</tr>
					<tr>
						<td class="td_left"><font color="#f00"> * </font>진료과</td>
						<td class="td_right">
							<select name="doctorDpt" class="box-dpt">
								<option selected="selected">진료과</option>
					...
					<tr>
						...
						<td class="td_right"><input type="text" name="doctorPhone" placeholder="'-'구분 없이 전화번호를 입력하세요." class="input"></td>
					</tr>
					<tr>
						<td class="td_left"><font color="#f00"> * </font>이메일</td>
						<td class="td_right"><input type="text" name="doctorEmail" placeholder="이메일을 입력하세요." class="input"></td>
					</tr>
					<tr>
	...
	<script>
		...
		$("#doctorId").on("blur", function() {
			...
			$.ajax({
				url : "/doctor/checkDupId.kh",
				type : "get",
				data : { "doctorId" : doctorId }, // JSON
