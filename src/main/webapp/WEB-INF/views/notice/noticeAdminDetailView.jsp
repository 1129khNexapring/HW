...
<head>
<meta charset="UTF-8">
<title>공지사항 상세히 보기 페이지(관리자)</title>
				...
				<div id="content_box">
					...
					<div class="section">
						<div class="bbs">
							...
							<div class="list_btn">
								<a id="list_l"  href="/notice/updateView.kh?noticeNo=${notice.noticeNo}">수정</a>
								<a id="list_l" href="/notice/delete.kh?noticeNo=${notice.noticeNo}">삭제</a>
							</div>
						</div>
					</div>
				</div>
...
<footer>
	<div class="footer_tit">서울특별시 중구 남대문로 120 대일빌딩 2F, 3F (T: 1544-9970) / F: 02-722-0858)</div><br>
