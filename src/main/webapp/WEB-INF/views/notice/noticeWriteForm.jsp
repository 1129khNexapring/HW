					...
					<form action="/notice/register.kh" method="post" >
						<table>
							...
							<tr>
								...
								<td><input type="text" class="input_text"  name="noticeTitle" placeholder="내용을 입력해주세요"></td>
							</tr>
							<tr>
								<td class="td-left">내용</td>
								<td><textarea name="noticeContents" class="textarea" style="white-space:pre;"></textarea></td>
							</tr>
					    </table>
						    <div class="enr_btn"><input type="submit" class="btn_blue"  value="완료" ></div>	
					     </form>
					</div>
				</div>
			</div>
