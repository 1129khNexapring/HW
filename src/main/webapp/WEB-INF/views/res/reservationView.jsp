         ...
         <table>
            ...
            <tr>
               <td colspan="2" align="center">
                  <button  class="submit" type="button" onclick="location.href='/res/remove.kh?resName=${loginNoUser.resName }&phone=${loginNoUser.phone }&birth=${loginNoUser.birth }'">예약 취소</button>
               </td>
            </tr>
         </table>
      </form>
