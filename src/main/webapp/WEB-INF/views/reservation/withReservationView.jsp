			...
			<div class="inner2">
				<div id="snb">
    				...
    				<ul class="snb_nav">
                        ...
                        <li><a href="/reservation/type.kh" class="link_sb1" id="point">동행서비스 예약 확인</a></li>
 					</ul>
			  </div>
				<div id="content_box">
					<div class="notice_page_title">
                <h2 class="tit_page">동행서비스 예약 정보</h2>		
             </div>
      ...
      <form>
         <table>
            ...
            <tr id="tr1">
               ...
               <td>
                  <span id="resName">${loginNoUser.resName }</span>
               </td>
            </tr>
            <tr id="tr1">
               <td class="td_left">예약자 생년월일</td>
               <td>
                  <span id="birth">${loginNoUser.birth }</span>
               </td>
            </tr>
            <tr id="tr1">
               <td class="td_left">예약자 주소</td>
               <td>
                  <span id="address">${loginNoUser.address }</span>
               </td>
            </tr>
            <tr id="tr1">
               <td class="td_left">예약자 전화번호</td>
               <td>
                  <span id="phone">${loginNoUser.phone }</span>
               </td>
            </tr>
            <tr id="tr1">
               <td class="td_left">진료과</td>
               <td>
                  <span id="department">${loginNoUser.department }</span>
               </td>
            </tr>
            <tr id="tr1">
               <td class="td_left">희망의료진</td>
               <td>
                  <span id="deptStaff">${loginNoUser.deptStaff }</span>
               </td>
            </tr>
            <tr id="tr1">
               <td class="td_left">보장구 이용선택</td>
               <td>
                  <span id="acc">${loginNoUser.acc }</span>
               </td>
            </tr>
            <tr id="tr1">
               <td class="td_left">진료날짜</td>
               <td>
                  <span id="deptDate">${loginNoUser.deptDate }</span>
               </td>
            </tr>
            <tr id="tr1">
               <td class="td_left">진료시간</td>
               <td>
                  <span id="deptTime">${loginNoUser.deptTime }</span>
               </td>
            </tr>
            <tr>
               <td colspan="2" align="center">
                  <button  class="submit" type="button" onclick="location.href='/reservation/remove.kh?resName=${loginNoUser.resName}&phone=${loginNoUser.phone }&birth=${loginNoUser.birth }'">예약 취소</button>
               </td>
            </tr>
         </table>
      </form>
