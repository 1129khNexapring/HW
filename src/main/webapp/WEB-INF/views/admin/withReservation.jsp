...
<div id="header">
			...
			<div class="inner2">
				<div id="snb">
    				...
    				<ul class="snb_nav">
						...
						<li><a href="/admin/withResList.kh" class="link_sb1" id="point">동행서비스 예약 관리</a></li>
						<li><a href="/notice/adlist.kh" class="link_sb1">공지사항 관리</a></li>   
						<li><a href="/qna/adlist.kh" class="link_sb1">문의/건의게시판 관리</a></li>
						<li><a href="/chat/list.kh" class="link_sb1">채팅 상담 관리</a></li>	
    					</ul>
			  </div>
			 <div id="content_box">
				<div class="notice_page_title">
					<h2 class="tit_page">동행 서비스 예약 관리</h2>		
				</div>
				<div class="section">
				<div class="bbs">
	<table>
			...
			<c:forEach items="${rList}" var="Reservation">
				<tr class="space">
					<td class="ta" id="tresNo">${Reservation.resNo }</td>
					...
					<td class="ta" id="address">${Reservation.address }</td>
					<td class="ta" id="acc">${Reservation.acc }</td>
					<td class="ta" id="fileRename">${Reservation.fileRename }</td>
				</tr>
			</c:forEach>
			</tbody>
	</table>
	<div class="paging">
			<c:if test="${pi.startNavi ==1 }">
				<a href="/admin/withResList.kh?page=1"> <i
			...
			<c:if test="${pi.prev}">
				...
				<a href="/admin/withResList.kh?page=${pi.startNavi-1}"> <i
					class="fas fa-angle-left">
						<button class="on">
				</i>
				</button>
			...
			<c:forEach var="p" begin="${pi.startNavi }" end="${pi.endNavi }">
				<c:url var="pagination" value="/admin/withResList.kh">
			...
			<c:if test="${pi.next && pi.endNavi > 0}">
				...
				<a href="/admin/withResList.kh?page=${pi.endNavi+1}"> <i
