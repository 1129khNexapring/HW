	...
	<div id="header">
        ...
        <div id="gnb">   
            ...
            <c:if test="${empty sessionScope}">
                <a href="/adlogin.kh" class="btn_gnb_login">
			...
			<div class="inner2">
					...
					<!--번호, 제목 , 작성자 , 날짜 , 조회수 -->
						...
						<c:forEach items="${qList}" var="qna">
								...
								<td class="ta" id="no">${qna.qnaNo }</td>
											...
											<c:url var="adDetail" value="/qna/adDetail.kh">
												<c:param name="qnaNo" value="${qna.qnaNo }"></c:param>
											</c:url>
            	...
            	(비밀글)
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Re:
										...
										<c:when test="${loginAdmin.memberId == 'admin' }">
														<a href="${adDetail }">${qna.qnaTitle }</a>
													</c:when>
						...
						<div class="paging">
								...
								<c:forEach var="p" begin="${pi.startNavi }" end="${pi.endNavi }">
									<c:url var="pagination" value="/qna/adlist.kh">
								...
								<c:if test="${pi.next && pi.endNavi > 0}">
									...
									<a href="/qna/adlist.kh?page=${pi.endNavi+1}"> <i
