			...
			<div class="inner2">
				<div id="snb">
    				...
    				<ul class="snb_nav">
    					...
    					<li><a href="/member/myInfo.kh" class="link_sb1" id="point">회원정보수정</a></li>
		...
		<form action="/member/modify.kh" method="post">
			<table>
				<tr>
					...
					<td class="td_right">
						<input type="text" name="memberName" readonly value="${loginUser.memberName }" class="input">
					</td>
				</tr>
				<tr>
					<td class="td_left">아이디</td>
					<td class="td_right">
						<input type="text" name="memberId" readonly value="${loginUser.memberId }" class="input">
					</td>
				</tr>
				<tr>
					<td class="td_left">비밀번호</td>
					<td class="td_right">
						<input type="password" name="memberPw" placeholder="비밀번호를 입력해주세요" value="" class="input" id="pw">
					</td>
				</tr>
					<tr>
					<td class="td_left">비밀번호 확인</td>
					<td class="td_right">
						<input type="password" name="memberPw2" placeholder="비밀번호를 한 번 더 입력해주세요" value="" class="input"  onchange="check_pw()" id="pw2">
						<span id="check"></span>
					</td>
				</tr>
				<tr>
					<td class="td_left">생년월일</td>
					<td class="td_right"><input type="date" name="memberBirth" value="${loginUser.memberBirth }" class="box-birth"></td>
				</tr>
				<tr>
					<td class="td_left">전화번호</td>
					<td class="td_right">
						<input type="text" name="memberPhone"  placeholder="'-'구분 없이 전화번호를 입력하세요." value="${loginUser.memberPhone }" class="input">
					</td>
				</tr>
				<tr>
					<td class="td_left">이메일</td>
					<td class="td_right">
						<input type="text" name="memberEmail" placeholder="이메일을 입력하세요." value="${loginUser.memberEmail }" class="input">
					</td>
				</tr>
				<tr>
