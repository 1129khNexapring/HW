...
public class ChatController {
	...
	public String doAdd(Model model, @ModelAttribute ChatRoom chatroom) throws UnsupportedEncodingException {
		try {
	...
	public String doMemAdd(Model model, @ModelAttribute ChatRoom chatroom) throws UnsupportedEncodingException {
		try {
	...
	public String doAdAdd(Model model, @ModelAttribute ChatRoom chatroom) throws UnsupportedEncodingException {
		try {
